...
var tulipJSON = '{"entry":{},"exit":{},"tracks":[],"glyphs":[]}'
...
QUnit.test("Waypoint Update", function( assert ) {
  ...
  waypoint.updateWaypoint(distances, heading, latLng, mapVertexIndex);
  ...
  assert.equal(waypoint.exactHeading(), heading, "It can update heading")
