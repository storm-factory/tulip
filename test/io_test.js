...
QUnit.test("IO ParseGpxTracksToArray", function( assert ) {
    var io = new Io();
...
QUnit.test("IO ProcessGpxTracksForImport", function( assert ) {
    var io = new Io();
    var tracks = $.makeArray($(gpx).find( "trkpt" ));
...
QUnit.test("IO WaypointSharesTrackpoint", function( assert ) {
    var io = new Io();
    var tracks = $.makeArray($(gpx).find( "trkpt" ));
